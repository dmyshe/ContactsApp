...
class DetailViewController: NSViewController {
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(AccountTextNoteCell.self, forItemWithIdentifier: AccountTextNoteCell.identifier)
    }
...
extension DetailViewController: NSCollectionViewDataSource {
    func collectionView(_ collectionView: NSCollectionView, itemForRepresentedObjectAt indexPath: IndexPath) -> NSCollectionViewItem {
        ...
        guard let item = collectionView.makeItem(withIdentifier: AccountTextNoteCell.identifier , for: indexPath) as? AccountTextNoteCell else {  return NSCollectionViewItem() }
